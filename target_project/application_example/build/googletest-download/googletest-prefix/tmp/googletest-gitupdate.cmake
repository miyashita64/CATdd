...
execute_process(
  COMMAND "/home/taki/etrobo/scripts/git" show-ref "release-1.11.0"
  WORKING_DIRECTORY "/mnt/c/Users/miyashita/Documents/wsl_box/CATdd/target_project/application_example/build/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/Users/miyashita/Documents/wsl_box/CATdd/target_project/application_example/build/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/Users/miyashita/Documents/wsl_box/CATdd/target_project/application_example/build/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
